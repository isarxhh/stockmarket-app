            ...
            <section className="auth-right-section">
                <div className="z-10 relative lg:mt-4 lg:mb-16">
                    <blockquote className="auth-blockquote">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur doloremque eaque error ex optio quia temporibus tenetur unde. Aliquam aspernatur fugit non. Ea, illo numquam recusandae rem sunt tempore velit!
                    </blockquote>
